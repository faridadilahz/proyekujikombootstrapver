@forelse ($beritas as $item) 
    <div class="col-md-4 col-sm-6">
        <div class="card h-100 shadow-sm border-0 rounded-3">
            ...
            <!-- 🟢 1. Bungkus Gambar & Teks Card dengan Link ke Detail Berita -->
            <a href="{{ route('berita.show', $item->id) }}" class="text-decoration-none text-dark">
                <img src="{{ asset('storage/' . $item->gambarberita) }}" alt="{{ $item->judulberita }}"
                    class="card-img-top rounded-top-3" style="height: 200px; object-fit: cover;">
            ...
            <div class="card-footer bg-transparent border-0 pt-0 pb-3 px-3 mt-auto">
                <div class="d-flex flex-column gap-2">
                    ...
                    <a href="{{ route('berita.edit', $item->id) }}"
                        class="btn btn-primary fw-semibold rounded-2 py-2 w-100">
