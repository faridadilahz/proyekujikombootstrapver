...
<html lang="en" data-bs-theme="light">
    ...
    <div class="mb-4">
        ...
        <div class="mb-2">
            <img src="{{  asset('storage/' . $galeris->gambargaleri) }}" alt="Gambar Saat Ini" class="rounded-3 shadow-sm" style="max-height: 150px; object-fit:cover;">
        </div>
        @endif

        <div class="upload-area shadow-sm" onclick="document.getElementById('gambargaleri').click();">
        ...
        <!-- 🟢 Atribut name="gambargaleri" -->
        <input type="file" name="gambargaleri" id="gambargaleri" class="d-none" accept="image/*" onchange="previewFileName(this)">
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="text" name="judulgaleri" id="judulgaleri" class="form-control border-0 shadow-sm rounded-3 py-3 pe-5" placeholder="Masukkan judul galeri disini" maxlength="255" value="{{ old('judulgaleri', $galeris->judulgaleri) }}" oninput="updateCharCount(this)" required>
            <span id="char-count" class="position-absolute top-50 end-0 translate-middle-y me-3 text-secondary small">{{ strlen($galeris->judulgaleri)}}/255</span>
        </div>
    </div>
    ...
    <div class="d-flex gap-3 mt-4">
        ...
        <a href="{{ route('galeri') }}" class="btn btn-outline-primary px-4 py-2 rounded-3 fw-semibold bg-white">
            Batal
        </a>
    </div>
