                ...
                <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="position-relative">
                            ...
                            <input type="text" name="judulberita" id="judulberita"
                                ...
                                placeholder="Masukkan judul berita disini" maxlength="255"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="deskripsiberita" id="deskripsiberita" rows="5"
                            class="form-control border-0 shadow-sm rounded-3 p-3" placeholder="Masukkan deskripsi berita disini" required></textarea>
                    </div>
