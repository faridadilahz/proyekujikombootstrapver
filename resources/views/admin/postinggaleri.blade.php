...
<html lang="en" data-bs-theme="light">
    ...
    <div class="mb-4">
        <label class="form-label text-dark fw-normal mb-2">Gambar galeri</label>
        <div class="upload-area shadow-sm" onclick="document.getElementById('gambargaleri').click();">
            ...
            <p class="mb-1 fw-medium text-dark">Masukkan foto galeri disini</p>
        ...
        <input type="file" name="gambargaleri" id="gambargaleri" class="d-none" accept="image/*" onchange="previewFileName(this)" required>
    </div>
    ...
    <div class="mb-4">
        ...
        <div class="position-relative">
            ...
            <input type="text" name="judulgaleri" id="judulgaleri" class="form-control border-0 shadow-sm rounded-3 py-3 pe-5" placeholder="Masukkan judul galeri disini" maxlength="255" oninput="updateCharCount(this)" required>
